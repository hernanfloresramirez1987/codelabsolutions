        ...
        <div class="py-12 px-12 mx-0 mt-20 lg:mx-20">
            <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12">
                <div class="col-span-12 md:col-span-2">
                    <a (click)="router.navigate(['/pages/landing'], { fragment: 'home' })" class="flex flex-wrap items-center justify-center md:justify-start md:mb-0 mb-12 cursor-pointer">
                ...
                <div class="col-span-12 md:col-span-10">
                    <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-20 text-center md:text-left">
                        <div class="col-span-12 md:col-span-3">
                            <h4 class="font-medium text-2xl leading-normal mb-12 text-surface-900 dark:text-surface-0">Company</h4>
                        ...
                        <div class="col-span-12 md:col-span-3">
                            <h4 class="font-medium text-2xl leading-normal mb-12 text-surface-900 dark:text-surface-0">Resources</h4>
                        ...
                        <div class="col-span-12 md:col-span-3">
                            <h4 class="font-medium text-2xl leading-normal mb-12 text-surface-900 dark:text-surface-0">Community</h4>
                        ...
                        <div class="col-span-12 md:col-span-3">
                            <h4 class="font-medium text-2xl leading-normal mb-12 text-surface-900 dark:text-surface-0">Legal</h4>
