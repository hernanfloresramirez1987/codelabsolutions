...
@Component({
    ...
    template: `
        <div id="highlights" class="py-12 px-12 lg:px-20 mx-0 my-12 lg:mx-20">
            ...
            <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12 mt-20 pb-2 md:pb-20">
                ...
                <div class="col-span-12 lg:col-span-6 my-auto flex flex-col lg:items-end text-center lg:text-right gap-12">
            ...
            <div class="grid grid-cols-12 gap-4 grid-cols-12 gap-6 grid-cols-12 gap-12 my-20 pt-2 md:pt-20">
                <div class="col-span-12 lg:col-span-6 my-auto flex flex-col text-center lg:text-left lg:items-start gap-12">
