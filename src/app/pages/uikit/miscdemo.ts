...
@Component({
    ...
    template: `
        <div class="card">
            <div class="font-semibold text-xl mb-12">ProgressBar</div>
        ...
        <div class="flex flex-col md:flex-row gap-20">
            <div class="md:w-1/2">
                <div class="card">
                    <div class="font-semibold text-xl mb-12">Badge</div>
                    ...
                    <div class="font-semibold my-12">Overlay</div>
                    ...
                    <div class="font-semibold my-12">Button</div>
                    <div class="flex gap-2">
                    ...
                    <div class="font-semibold my-12">Sizes</div>
                ...
                <div class="card">
                    <div class="font-semibold text-xl mb-12">Avatar</div>
                    <div class="font-semibold mb-12">Group</div>
                    <p-avatargroup styleClass="mb-12">
                    ...
                    <div class="font-semibold my-12">Label - Circle</div>
                    ...
                    <div class="font-semibold my-12">Icon - Badge</div>
                ...
                <div class="card">
                    <div class="font-semibold text-xl mb-12">Skeleton</div>
            ...
            <div class="md:w-1/2">
                <div class="card">
                    <div class="font-semibold text-xl mb-12">Tag</div>
                    <div class="font-semibold mb-12">Default</div>
                    <div class="flex gap-2">
                    ...
                    <div class="font-semibold my-12">Pills</div>
                    <div class="flex gap-2">
                    ...
                    <div class="font-semibold my-12">Icons</div>
                    <div class="flex gap-2">
                ...
                <div class="card">
                    <div class="font-semibold text-xl mb-12">Chip</div>
                    <div class="font-semibold mb-12">Basic</div>
                    ...
                    <div class="font-semibold my-12">Icon</div>
                    <div class="flex items-center flex-col sm:flex-row">
                    ...
                    <div class="font-semibold my-12">Image</div>
                    <div class="flex items-center flex-col sm:flex-row">
