...
@Component({
    ...
    template: `
        <div class="card">
            <div class="font-semibold text-2xl mb-12">Documentation</div>
            <div class="font-semibold text-xl mb-12">Get Started</div>
            <p class="text-lg mb-12">Sakai is an application template for Angular and is distributed as a CLI project. Current versions is Angular v19 with PrimeNG v19. In case CLI is not installed already, use the command below to set it up.</p>
            <pre class="app-code">
...
ng serve</code></pre>
            ...
            <p class="text-lg mb-12">The application should run at <i class="bg-highlight px-2 py-1 rounded-border not-italic text-base">http://localhost:4200/</i> to view the application in your local environment.</p>

            <div class="font-semibold text-xl mb-12">Structure</div>
            <p class="text-lg mb-12">Templates consists of a couple folders, demos and layout have been separated so that you can easily identify what is necessary for your application.</p>
            <ul class="leading-normal list-disc pl-20 text-lg mb-12">
            ...
            <div class="font-semibold text-xl mb-12">Menu</div>
            <p class="text-lg mb-12">
            ...
            <div class="font-semibold text-xl mb-12">Layout Service</div>
            <p class="text-lg mb-12">
            ...
            <div class="font-semibold text-xl mb-12">Tailwind CSS</div>
            <p class="text-lg mb-12">The demo pages are developed with Tailwind CSS however the core application shell uses custom CSS.</p>

            <div class="font-semibold text-xl mb-12">Variables</div>
            <p class="text-lg mb-12">
